      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="admin-menu">
          <ul id="side-admin-menu" class="side-menu list-unstyled">
            ...
            <li class="active"> <a href="<?php echo base_url(); ?>operator/list_peserta"> <i class="fa fa-pencil"></i><span>Data Laporan</span></a></li>
            </li>
          </ul>
        </div>
      </div>
              ...
              <div class="card bar-chart-example">
                <div class="card-header d-flex align-items-center row asd">
                  <div class="d-flex p-2">
                    <h2 class="h5 display">List Peserta Yang Akan Dilaporkan</h2>
                  </div>
