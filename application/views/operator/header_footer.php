...
<head>
    ...
    <!-- datatables -->
    <?php if($this->uri->segment(2) == "list_peserta"){
            if($this->uri->segment(3) == "tulis_laporan"){ 
    ?>
...
<body>
    ...
    <?php 
    if($this->uri->segment(2) == "list_peserta"){
        if($this->uri->segment(3) == "tulis_laporan"){
    ?>
    ...
    <script src="<?php echo base_url(); ?>assets/js/app_op.js"></script>
