...
<html lang="en">
  <head>
    ...
    <title>Soal Trial - Sistem Ujian Online Universitas Diponegoro</title>
   ...
   <body class="index-page" style="background: url(&apos;/Aplikasi_CBT/assets/img/back02.jpg&apos;)">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card card-nav-tabs">
                                 ...
                                 <ul class="nav nav-tabs" data-tabs="tabs">
                                  <li class="nav-item">
                                   ...
                                   <li class="nav-item ml-auto">
                                    <div class="nav-link soal">
                                      <div class="btn btn-rose btn-sm" style="padding: 0.120625rem 1.25rem;margin: 4px;font-size: 16px;" id="waktu_countdown"></div> 
                                    </div>
                                   </li>
                                  </ul>
                                </div>
                           ...
                           <div class="card-footer baris">
                                ...
                                <a class="btn btn-soal-bottom btn-success btn-lg ml-auto" id="submit" onclick="return simpan_jawaban();" style="color:#fff;"><strong><i class="material-icons">done_all</i>&nbsp;&nbsp;Selesai Ujian</strong></a>
    ...
    <script>
        ...
        simpan = function(){
            ...
            $.ajax({
                type : "POST",
                url : base_url+"peserta/simpan_jwb_trial",
                data : data,     
            ...
            swal({
              ...
              onOpen: () => {swal.showLoading()}
                ...
                var data = $('#_form').serialize();
                    $.ajax({
                        type: "POST",
                        url: base_url+"peserta/hitung_nilai_trial",
                        data : data,
                    }).done(function(response) {
                        if (response.status == "ok") {
                            localStorage.setItem("sukses",response.msg);
                            window.location.assign(base_url+"peserta/persiapan_trial_ujian"); 
                        } else {
        ...
        simpan_jawaban = function(){
            swal({
              title: 'Apa kamu yakin ingin mengakhiri tes ini?',
              text: 'Aksi ini akan menyimpan nilai ujian tes dan tidak dapat diulangi kembali',
              type: 'warning',
