    ...
    <div class="page home-page">
      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>administrator/datapeserta">Data Peserta</a></li>
      ...
      <section class="charts">
        <div class="container-fluid">
          ...
          <div class="alert alert-info"><strong>Info :</strong><br>1. File yang bisa diimport hanya format excel (.xls) atau (.xlsx)<br>2. Pastikan file yang akan diimport sesuai format yang sudah disediakan dengan unduh file <strong><a href="<?php echo base_url(); ?>upload/contoh data.xls" class="link-unduh">disini</a></strong></div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center row asd">
                  <div class="d-flex p-2"><h2 class="h5 display">Import Data Peserta</h2></div>
                </div>
                <div class="card-body">
                  <div class="table table-form">
                    ...
                    <?php endif;?>
                    <?php echo form_open_multipart(base_url().'import/siswa','id="import_siswa"');?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url(); ?>administrator/datapeserta" class="btn btn-default"><i class="fa fa-minus-circle"></i> Kembali</a>
                    </td>
                    </tr>
                    </table>
                    </form>
