...
<nav class="side-navbar">
    ...
    <div class="page home-page">
      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Bank Soal Versi 1</li>
          </ul>
        </div>
      </div>
      <section class="charts">
        <div class="container-fluid">
          <header> 
            <h1 class="h3">Bank Soal Versi 1</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center row">
                  <div class="d-flex p-2"><h2 class="h5 display">Tabel Data Soal Versi 1</h2></div>
                    <div class="ml-auto p-2 text-right">
                      <a href="<?php echo base_url(); ?>administrator/banksoalv1/edit/0" class="btn btn-info btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Tambah data</a>
                      <a href="<?php echo base_url(); ?>administrator/banksoalv1/import" class="btn btn-success btn-sm "><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;&nbsp;Import Data</a>
                    </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="dataversi1" class="display table table-bordered">
