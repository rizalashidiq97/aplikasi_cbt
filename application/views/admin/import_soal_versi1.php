      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Import Data Soal Versi 1</li>
          </ul>
        </div>
      </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center row asd">
                  <div class="d-flex p-2"><h2 class="h5 display">Import Data Soal Versi 1</h2></div>
                </div>
                <div class="card-body">
                  <div class="table table-form">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?php echo base_url(); ?>administrator/banksoalv1" class="btn btn-default"><i class="fa fa-minus-circle"></i> Kembali</a>
                    </td>
                    </tr>
                    </table>
                    </form>
