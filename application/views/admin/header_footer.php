...
<head>
    ...
    <!-- datatables -->
    <?php if($this->uri->segment(2) == "soaltrial" || $this->uri->segment(2) == "banksoalv1" || $this->uri->segment(2) == "banksoalv2" || $this->uri->segment(2) == "banksoalv3"){
            if($this->uri->segment(3) == "edit"){ 
    ?>
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/froala_editor_2.7.3/css/froala_editor.pkgd.min.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/vendor/froala_editor_2.7.3/css/froala_style.min.css">
    <?php 
        }
    }
    ?>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?>assets/img/logo undip.png" />
</head>
<body>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-sm-4 text-center">
              <p style="color: white"><script>
                  var event = new Date();
                  var options = { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' };
                  document.write(event.toLocaleDateString('id-ID',(options)));
              </script></p>
            </div>
    ...
    <?php 
        if($this->uri->segment(2) == "dashboard" && $this->uri->segment(1) == "administrator"){ 
    ?>
    <script src="<?php echo base_url(); ?>assets/vendor/chart.js/Chart.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/dashboard.js"></script>
    <?php 
    }
    if($this->uri->segment(2) == "soaltrial" || $this->uri->segment(2) == "banksoalv1" || $this->uri->segment(2) == "banksoalv2" || $this->uri->segment(2) == "banksoalv3"){

        if($this->uri->segment(3) == "edit"){
    ?>
    <script src="<?php echo base_url(); ?>assets/vendor/froala_editor_2.7.3/js/froala_editor.pkgd.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/vendor/froala_editor_2.7.3/js/plugins/image.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/vendor/froala_editor_2.7.3/js/plugins/image_manager.min.js"></script>
    <?php
        }
    } 
    ?>
