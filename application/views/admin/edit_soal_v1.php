      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>administrator/banksoalv1">Bank Soal Versi 1</a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php endif;?>
                    <?php echo form_open_multipart(base_url()."administrator/banksoalv1/simpan",'class="formtrial" id="formtrial"');?>
                    <input type="hidden" name="mode" id="mode" value="<?php echo $data['mode']; ?>">
                    <input type="hidden" name="id" id="id" value="<?php echo $data['id']; ?>">
                    <input type="hidden" name="versi" id="versi" value="<?php echo $data['versi']; ?>">
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-10">
                          ...
                          <a href="<?php echo base_url(); ?>administrator/banksoalv1" class="btn btn-default"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                        </div>
                      </div>
                      <?php echo form_close();?>
                </div>
