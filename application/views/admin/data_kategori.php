<nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="admin-menu">
          <ul id="side-admin-menu" class="side-menu list-unstyled">
            ...
            <li  class="active"> <a href="<?php echo base_url(); ?>administrator/kategorisoal"> <i class="fa fa-hand-o-right"> </i><span>Kategori Soal</span></a></li>
    ...
    <div class="page home-page">
      ...
      <section class="charts">
        <div class="container-fluid">
          <header> 
            <h1 class="h3">Data Kategori</h1>
          </header>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center row">
                  <div class="d-flex p-2"><h2 class="h5 display">Tabel Data Kategori</h2></div>
                    <div class="ml-auto p-2 text-right">
                      <a href="#" class="btn btn-info btn-sm" onclick="return m_kategori(0);"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Tambah data</a>
                    </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="datakategori" class="display table table-bordered">
      ...
      <div id="m_datakategori" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <div id="header-modal-kategori"></div>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
            </div>
            <form name="edit_kategori" id="edit_kategori" onsubmit="return m_simpan_kategori();">
              <div class="modal-body">
                  <input type="hidden" name="id" id="id" value="0">
                  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                  <table class="table table-form">
                    <tr>
                      <td style="width: 25%">Kategori</td><td style="width: 75%">
                        <input type="text" class="form-control" name="kategori" id="kategori" required></td>
                    </tr>
                  </table>
              </div>
