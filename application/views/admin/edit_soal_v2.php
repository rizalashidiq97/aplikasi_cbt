      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>administrator/banksoalv2">Bank Soal Versi 2</a></li>
            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php endif;?>
                    <?php echo form_open_multipart(base_url()."administrator/banksoalv2/simpan",'class="formtrial" id="formtrial"');?>
                    ...
                    <input type="hidden" name="versi" id="versi" value="<?php echo $data['versi']; ?>">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-10">
                          ...
                          <a href="<?php echo base_url(); ?>administrator/banksoalv2" class="btn btn-default"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                        </div>
                      </div>
                      <?php echo form_close();?>
                </div>
