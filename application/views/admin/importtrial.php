<nav class="side-navbar">
    ...
    <div class="page home-page">
      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>administrator/soaltrial">Soal Trial</a></li>
            <li class="breadcrumb-item active">Import Data Soal Trial</li>
          </ul>
        </div>
      </div>
      <section class="charts">
        <div class="container-fluid">
          <header> 
            <h1 class="h3">Import File</h1>
          </header>
          <div class="alert alert-info"><strong>Info :</strong><br>1. File yang bisa diimport hanya format excel (.xls) atau (.xlsx)<br>2. Pastikan file yang akan diimport sesuai format yang sudah disediakan dengan unduh file <strong><a href="<?php echo base_url(); ?>upload/contoh trial.xlsx" class="link-unduh">disini</a></strong></div>
          <div class="row">
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center row asd">
                  <div class="d-flex p-2"><h2 class="h5 display">Import Data Soal Trial</h2></div>
                </div>
                <div class="card-body">
                  <div class="table table-form">
                    ...
                    <?php endif;?>
                    <?php echo form_open_multipart(base_url()."import/soaltrial",'id="import_trial"');?>
                    <input type="hidden" name="id" id="id" value="0">
                    <table class="table table-form">
                    <tr>
                      <td style="width: 15%"><strong>File</strong></td>
                      <td style="width: 85%">
                        <input type="file" class="form-control" name="import_trial" required>
                      </td>
                    </tr>
                    <tr>
                      <td></td>
                      <td>
                        ...
                        <a href="<?php echo base_url(); ?>administrator/soaltrial" class="btn btn-default"><i class="fa fa-minus-circle"></i> Kembali</a>
                    </td>
                    </tr>
                    </table>
                    </form>
