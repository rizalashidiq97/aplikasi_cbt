            ...
            <div class="col-lg-12">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php endif;?>
                    <?php echo form_open_multipart(base_url()."administrator/banksoalv3/simpan",'class="formtrial" id="formtrial"');?>
                    ...
                    <input type="hidden" name="versi" id="versi" value="<?php echo $data['versi']; ?>">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-10">
                          ...
                          <a href="<?php echo base_url(); ?>administrator/banksoalv3" class="btn btn-default"><i class="fa fa-arrow-left"></i>&nbsp;&nbsp;Kembali</a>
                        </div>
                      </div>
                      <?php echo form_close();?>
                </div>
