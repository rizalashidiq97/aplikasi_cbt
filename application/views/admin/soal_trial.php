      ...
      <div class="breadcrumb-holder">   
        <div class="container-fluid">
          <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Data Soal Trial</li>
          </ul>
        </div>
      </div>
            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header d-flex align-items-center row">
                  <div class="d-flex p-2"><h2 class="h5 display">Tabel Data Soal Trial</h2></div>
                    <div class="ml-auto p-2 text-right">
                      <a href="<?php echo base_url(); ?>administrator/soaltrial/edit/0" class="btn btn-info btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i>&nbsp;&nbsp;Tambah data</a>
                      <a href="<?php echo base_url(); ?>administrator/soaltrial/importtrial" class="btn btn-success btn-sm"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;&nbsp;Import data</a>
                      <button class="btn btn-danger btn-sm" onclick="return h_soaltrial_all();"><i class="fa fa-trash" aria-hidden="true"></i>&nbsp;&nbsp;Hapus semua data</button>
                    </div>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="datatrial" class="display table table-bordered">
